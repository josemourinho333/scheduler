...
describe('Application Tests', () => {
  ...
  it("loads data, cancels an interview and increases the spots remaining for Monday by 1", async () => {
    ...
    const confirm = getAllByTestId(container, 'confirm').find(confirm => 
      queryByText(confirm, 'Are you sure you would like to delete?')
    );
  ...
  it("shows the delete error when failing to delete an appointment", async () => {
    ...
    // // 6. Check that the element with the text "Deleting" is displayed.
    expect(getByText(appointment, 'Deleting')).toBeInTheDocument();
    // Error happens and expect to have error element data-testid='error'
    await waitForElement(() => queryByText(appointment, "Problem with deleting appointment"));
  ...
  it("shows the save error when failing to save an appointment", async () => {
    ...
    await waitForElement(() => queryByText(appointment, "Problem with saving appointment"));
